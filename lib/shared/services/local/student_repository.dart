...
class StudentRepository {
  ...
  Future<void> delete(String id) async {
    await (_db.delete(
      _db.studentEntries,
    )..where((StudentEntries t) => t.id.equals(id))).go();
  }
  ...
  Future<void> markFailed(String id, String error, int previousAttempts) =>
      _patchSync(
        id,
        StudentEntriesCompanion(
  ...
  Future<void> resetFailures(String schoolId) async {
    await (_db.update(_db.studentEntries)..where(
          (StudentEntries t) =>
  ...
  Future<int> resetStaleSyncing({
    ...
    return (_db.update(_db.studentEntries)..where(
          (StudentEntries t) =>
  ...
  Future<void> approve(String id, {required String reviewerUid}) async {
    await (_db.update(
      _db.studentEntries,
    )..where((StudentEntries t) => t.id.equals(id))).write(
      StudentEntriesCompanion(
  ...
  Future<List<StudentEntry>> printableForSchool(String schoolId) async {
    ...
    return rows.map(_toDomain).where((StudentEntry e) => e.hasPhoto).toList();
  }
  ...
  Future<void> _patchSync(String id, StudentEntriesCompanion patch) async {
    await (_db.update(
      _db.studentEntries,
    )..where((StudentEntries t) => t.id.equals(id))).write(patch);
  }
  ...
  static StudentEntriesCompanion _toCompanion(StudentEntry e) =>
      StudentEntriesCompanion(
